...
interface NotificationDataContextType {
  ...
  unregisterNotification: (tripPointId: string) => Promise<void>;
  isRegistered: (tripPointId: string) => boolean;
  getNotificationId: (tripPointId: string) => string | null;
}
...
export const NotificationDataProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
